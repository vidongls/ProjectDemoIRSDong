...
const PurchaseOrder: React.FC<IPurchaseOrder> = () => {
	...
	return (
		<>
			...
			>
				...
				>
					<SupplierSelect field="code" placeholder="Nhập mã nhà cung cấp" />
				</Form.Item>
				<Form.Item
				...
				>
					<SupplierSelect field="name" placeholder="Nhập tên nhà cung cấp" />
				</Form.Item>
				<Form.Item
					label="Ngày chứng từ"
					name="day_vouchers"
